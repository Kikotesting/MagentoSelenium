...
//        homePage.pauseSeconds(1);
//
//        Assertions.assertEquals(GlobalConstants.MY_ACCOUNT, accountPage.myAccountTextHeader.getText());
//        highLightElement(driver, accountPage.accountInfoText);
//        Assertions.assertEquals(GlobalConstants.ACCOUNT_INFORMATION, accountPage.accountInfoText.getText());
//        highLightElement(driver, accountPage.accountContactInfoText);
//        Assertions.assertEquals(GlobalConstants.ACCOUNT_CONTACT_INFORMATION, accountPage.accountContactInfoText.getText());
//        highLightElement(driver, accountPage.accountNewslettersText);
//        Assertions.assertEquals(GlobalConstants.ACCOUNT_NEWSLETTERS_INFORMATION, accountPage.accountNewslettersText.getText());
...
//        Assertions.assertEquals(GlobalConstants.ADDRESS_BOOK, accountPage.addressBookInfo.getText());
//        highLightElement(driver, accountPage.defaultBillingAddress);
//        Assertions.assertEquals(GlobalConstants.ADDRESS_BOOK_DEFAULT_BILLING_ADDRESS, accountPage.defaultBillingAddress.getText());
//        highLightElement(driver, accountPage.defaultBillingAddress);
//        Assertions.assertEquals(GlobalConstants.ADDRESS_BOOK_DEFAULT_SHIPPING_ADDRESS, accountPage.defaultShippingAddress.getText());
//
//    }
//
//    @Test
...
//        homePage.pauseSeconds(1);
//        Assertions.assertEquals(GlobalConstants.SIGN_OUT_SUCCESS_MESSAGE, loginPage.signOutMessageHeader.getText());
//        Assertions.assertEquals(GlobalConstants.SIGN_OUT_SUCCESS_MESSAGE_PARAGRAPH, loginPage.signOutMessageParagraph.getText());
